...
class ExpectCTTrackerTest extends \WP_UnitTestCase
{
    ...
    public function test_get_dsn()
    {
        ...
        add_filter('sentry_integration_expect_ct_dsn', $closure);

        $this->assertEquals($sentry_integration_dsn, $this->tracker->get_dsn());

        remove_filter('sentry_integration_expect_ct_dsn', $closure);
    }
    ...
    public function test_get_options()
    {
        ...
        add_filter('sentry_integration_expect_ct_options', $closure);
        ...
        remove_filter('sentry_integration_expect_ct_options', $closure);
    }
